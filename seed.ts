...
const plovdivBusinesses: BusinessData[] = [
  // HAIR - 10 businesses
  ...
  { name: 'GLAMOUR Nails', contactPerson: 'Галя Николова', email: 'glamour@abv.bg', phone: '+359885123419', address: 'ул. "Заводска" 5, Пловдив', description: 'Гlamour студио за нокти с най-новите тенденции.', category: 'nails', rating: 4.7, reviewCount: 134 },
...
const services: ServiceData[] = [
  // Hair services
  { name: 'Мъжко подстригване', category: 'hair', subtype: 'cut', price: 25, duration: 30 },
  { name: 'Дамско подстригване', category: 'hair', subtype: 'cut', price: 35, duration: 45 },
  { name: 'Боядисване на коса', category: 'hair', subtype: 'color', price: 80, duration: 120 },
  { name: 'Осветяване', category: 'hair', subtype: 'highlights', price: 100, duration: 150 },
  { name: 'Балиаж', category: 'hair', subtype: 'balayage', price: 120, duration: 180 },
  { name: 'Кератиново третиране', category: 'hair', subtype: 'treatment', price: 90, duration: 120 },
  { name: 'Прическа за събитие', category: 'hair', subtype: 'styling', price: 60, duration: 60 },
  { name: 'Брада оформяне', category: 'hair', subtype: 'beard', price: 20, duration: 20 },

  // Nails services
  { name: 'Класически маникюр', category: 'nails', subtype: 'manicure', price: 25, duration: 30 },
  { name: 'Гел маникюр', category: 'nails', subtype: 'gel', price: 45, duration: 60 },
  { name: 'Акрил нокти', category: 'nails', subtype: 'acrylic', price: 55, duration: 90 },
  { name: 'Педикюр', category: 'nails', subtype: 'pedicure', price: 35, duration: 45 },
  { name: 'SPA педикюр', category: 'nails', subtype: 'spa', price: 50, duration: 60 },
  { name: 'Ремонт на нокти', category: 'nails', subtype: 'repair', price: 15, duration: 20 },
  { name: 'Дизайн на нокти', category: 'nails', subtype: 'art', price: 20, duration: 30 },
  { name: 'Гел лак', category: 'nails', subtype: 'shellac', price: 40, duration: 45 },

  // Skin services
  { name: 'Почистване на лице', category: 'skin', subtype: 'cleaning', price: 40, duration: 45 },
  { name: 'Хидратиращо третиране', category: 'skin', subtype: 'hydrating', price: 55, duration: 60 },
  { name: 'Анти-ейдж третиране', category: 'skin', subtype: 'anti-aging', price: 70, duration: 75 },
  { name: 'Микродермабразио', category: 'skin', subtype: 'microderm', price: 65, duration: 60 },
  { name: 'Химически пилинг', category: 'skin', subtype: 'peeling', price: 60, duration: 45 },
  { name: 'Лазерна епилация (лице)', category: 'skin', subtype: 'laser', price: 50, duration: 30 },
  { name: 'Лазерна епилация (тяло)', category: 'skin', subtype: 'laser', price: 80, duration: 60 },
  { name: 'Колагенова терапия', category: 'skin', subtype: 'collagen', price: 85, duration: 90 },

  // Massage services
  { name: 'Релаксиращ масаж', category: 'massage', subtype: 'relax', price: 60, duration: 60 },
  { name: 'Спортен масаж', category: 'massage', subtype: 'sport', price: 80, duration: 60 },
  { name: 'Лечебен масаж', category: 'massage', subtype: 'therapeutic', price: 70, duration: 45 },
  { name: 'Шведски масаж', category: 'massage', subtype: 'swedish', price: 65, duration: 60 },
  { name: 'Дълбок тъканен масаж', category: 'massage', subtype: 'deep', price: 75, duration: 60 },
  { name: 'Масаж с горени камъни', category: 'massage', subtype: 'hotstone', price: 85, duration: 75 },
  { name: 'Тайландски масаж', category: 'massage', subtype: 'thai', price: 90, duration: 90 },
  { name: 'Ароматерапия', category: 'massage', subtype: 'aromatherapy', price: 70, duration: 60 },

  // Makeup services
  { name: 'Дневен грим', category: 'makeup', subtype: 'day', price: 50, duration: 45 },
  { name: 'Вечерен грим', category: 'makeup', subtype: 'evening', price: 70, duration: 60 },
  { name: 'Свадебен грим', category: 'makeup', subtype: 'bridal', price: 150, duration: 120 },
  { name: 'Грим за фотосесия', category: 'makeup', subtype: 'photo', price: 80, duration: 60 },
  { name: 'Консултация за грим', category: 'makeup', subtype: 'consult', price: 40, duration: 30 },
  { name: 'Прическа + грим', category: 'makeup', subtype: 'combo', price: 100, duration: 90 },

  // Brows services
  { name: 'Оформяне на вежди', category: 'brows', subtype: 'shaping', price: 20, duration: 20 },
  { name: 'Ламиниране на вежди', category: 'brows', subtype: 'lamination', price: 60, duration: 60 },
  { name: 'Микроблейдинг', category: 'brows', subtype: 'microblade', price: 250, duration: 120 },
  { name: 'Ботокс за вежди', category: 'brows', subtype: 'botox', price: 80, duration: 45 },
  { name: 'Боядисване на вежди', category: 'brows', subtype: 'color', price: 25, duration: 25 },
  { name: 'Миглопластика', category: 'brows', subtype: 'lashes', price: 70, duration: 60 },
  { name: 'Ламиниране на мигли', category: 'brows', subtype: 'lashlam', price: 65, duration: 60 },
  { name: 'Перманентен грим (вежди)', category: 'brows', subtype: 'permanent', price: 200, duration: 90 },
];

async function main() {
  console.log('Seeding database with Plovdiv businesses...');
  ...
  for (const businessData of plovdivBusinesses) {
    ...
    if (!existingBusiness) {
      ...
      const categoryServices = services.filter(s => s.category === businessData.category);
      const randomServices = categoryServices.sort(() => 0.5 - Math.random()).slice(0, 6);

      for (const serviceData of randomServices) {
      ...
      console.log(`Created: ${business.name} (${business.category})`);
    } else {
      console.log(`Skipped (exists): ${businessData.name}`);
    }
  }

  console.log('Database seeded with Plovdiv businesses!');
}
