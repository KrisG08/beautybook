...
async function main() {
  ...
  const businesses = [
    ...
    { userId: userIds[3], name: 'Barber Studio 2', contactPerson: 'Maria', phone: '+359 88 456 7890', email: 'barberstudio2@plovdiv.bg', address: 'ulitsa "Filip Makedonski" 49B, Plovdiv 4000', description: 'Second location near Plovdiv Central. Quality service.', category: 'hair', imageUrl: 'https://images.unsplash.com/photo-1568605117036-5f7ff8747e29?w=400', status: 'approved', rating: 5.0, reviewCount: 203 },
